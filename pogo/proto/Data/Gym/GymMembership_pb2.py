...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Data/Gym/GymMembership.proto',
  package='POGOProtos.Data.Gym',
  syntax='proto3',
  serialized_pb=_b('\n\x1c\x44\x61ta/Gym/GymMembership.proto\x12\x13POGOProtos.Data.Gym\x1a\x16\x44\x61ta/PokemonData.proto\x1a%Data/Player/PlayerPublicProfile.proto\"\x90\x01\n\rGymMembership\x12\x32\n\x0cpokemon_data\x18\x01 \x01(\x0b\x32\x1c.POGOProtos.Data.PokemonData\x12K\n\x16trainer_public_profile\x18\x02 \x01(\x0b\x32+.POGOProtos.Data.Player.PlayerPublicProfileb\x06proto3')
  ,
  dependencies=[Data_dot_PokemonData__pb2.DESCRIPTOR,Data_dot_Player_dot_PlayerPublicProfile__pb2.DESCRIPTOR,])
...
_GYMMEMBERSHIP.fields_by_name['pokemon_data'].message_type = Data_dot_PokemonData__pb2._POKEMONDATA
_GYMMEMBERSHIP.fields_by_name['trainer_public_profile'].message_type = Data_dot_Player_dot_PlayerPublicProfile__pb2._PLAYERPUBLICPROFILE
...
GymMembership = _reflection.GeneratedProtocolMessageType('GymMembership', (_message.Message,), dict(
  ...
  __module__ = 'Data.Gym.GymMembership_pb2'
