...
_PLAYERBADGE.fields_by_name['badge_type'].enum_type = Enums_dot_BadgeType__pb2._BADGETYPE
...
PlayerBadge = _reflection.GeneratedProtocolMessageType('PlayerBadge', (_message.Message,), dict(
  ...
  __module__ = 'Data.PlayerBadge_pb2'
