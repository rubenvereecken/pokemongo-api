...
_BATTLEPOKEMONINFO.fields_by_name['pokemon_data'].message_type = Data_dot_PokemonData__pb2._POKEMONDATA
...
BattlePokemonInfo = _reflection.GeneratedProtocolMessageType('BattlePokemonInfo', (_message.Message,), dict(
  ...
  __module__ = 'Data.Battle.BattlePokemonInfo_pb2'
