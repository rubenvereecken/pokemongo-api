...
_BATTLEPARTICIPANT.fields_by_name['active_pokemon'].message_type = Data_dot_Battle_dot_BattlePokemonInfo__pb2._BATTLEPOKEMONINFO
_BATTLEPARTICIPANT.fields_by_name['trainer_public_profile'].message_type = Data_dot_Player_dot_PlayerPublicProfile__pb2._PLAYERPUBLICPROFILE
_BATTLEPARTICIPANT.fields_by_name['reverse_pokemon'].message_type = Data_dot_Battle_dot_BattlePokemonInfo__pb2._BATTLEPOKEMONINFO
_BATTLEPARTICIPANT.fields_by_name['defeated_pokemon'].message_type = Data_dot_Battle_dot_BattlePokemonInfo__pb2._BATTLEPOKEMONINFO
...
BattleParticipant = _reflection.GeneratedProtocolMessageType('BattleParticipant', (_message.Message,), dict(
  ...
  __module__ = 'Data.Battle.BattleParticipant_pb2'
