...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Settings/DownloadSettingsAction.proto',
  package='POGOProtos.Settings',
  syntax='proto3',
  serialized_pb=_b('\n%Settings/DownloadSettingsAction.proto\x12\x13POGOProtos.Settings\"&\n\x16\x44ownloadSettingsAction\x12\x0c\n\x04hash\x18\x01 \x01(\tb\x06proto3')
)
...
DownloadSettingsAction = _reflection.GeneratedProtocolMessageType('DownloadSettingsAction', (_message.Message,), dict(
  ...
  __module__ = 'Settings.DownloadSettingsAction_pb2'
