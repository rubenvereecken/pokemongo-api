...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Settings/Master/MoveSequenceSettings.proto',
  package='POGOProtos.Settings.Master',
  syntax='proto3',
  serialized_pb=_b('\n*Settings/Master/MoveSequenceSettings.proto\x12\x1aPOGOProtos.Settings.Master\"(\n\x14MoveSequenceSettings\x12\x10\n\x08sequence\x18\x01 \x03(\tb\x06proto3')
)
...
MoveSequenceSettings = _reflection.GeneratedProtocolMessageType('MoveSequenceSettings', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.MoveSequenceSettings_pb2'
