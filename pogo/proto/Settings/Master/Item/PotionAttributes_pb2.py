...
# source: Settings/Master/Item/PotionAttributes.proto
...
PotionAttributes = _reflection.GeneratedProtocolMessageType('PotionAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Item.PotionAttributes_pb2'
