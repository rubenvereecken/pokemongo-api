...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Settings/Master/Item/ReviveAttributes.proto',
  package='POGOProtos.Settings.Master.Item',
  syntax='proto3',
  serialized_pb=_b('\n+Settings/Master/Item/ReviveAttributes.proto\x12\x1fPOGOProtos.Settings.Master.Item\"\'\n\x10ReviveAttributes\x12\x13\n\x0bsta_percent\x18\x01 \x01(\x02\x62\x06proto3')
)
...
ReviveAttributes = _reflection.GeneratedProtocolMessageType('ReviveAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Item.ReviveAttributes_pb2'
