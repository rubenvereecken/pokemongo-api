...
ExperienceBoostAttributes = _reflection.GeneratedProtocolMessageType('ExperienceBoostAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Item.ExperienceBoostAttributes_pb2'
