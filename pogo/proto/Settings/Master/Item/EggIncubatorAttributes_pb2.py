...
_EGGINCUBATORATTRIBUTES.fields_by_name['incubator_type'].enum_type = Inventory_dot_EggIncubatorType__pb2._EGGINCUBATORTYPE
...
EggIncubatorAttributes = _reflection.GeneratedProtocolMessageType('EggIncubatorAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Item.EggIncubatorAttributes_pb2'
