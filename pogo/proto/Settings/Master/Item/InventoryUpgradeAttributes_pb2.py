...
_INVENTORYUPGRADEATTRIBUTES.fields_by_name['upgrade_type'].enum_type = Inventory_dot_InventoryUpgradeType__pb2._INVENTORYUPGRADETYPE
...
InventoryUpgradeAttributes = _reflection.GeneratedProtocolMessageType('InventoryUpgradeAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Item.InventoryUpgradeAttributes_pb2'
