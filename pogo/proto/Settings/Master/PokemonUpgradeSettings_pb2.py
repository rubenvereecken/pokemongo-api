...
PokemonUpgradeSettings = _reflection.GeneratedProtocolMessageType('PokemonUpgradeSettings', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.PokemonUpgradeSettings_pb2'
