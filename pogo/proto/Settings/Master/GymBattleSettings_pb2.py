...
GymBattleSettings = _reflection.GeneratedProtocolMessageType('GymBattleSettings', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.GymBattleSettings_pb2'
