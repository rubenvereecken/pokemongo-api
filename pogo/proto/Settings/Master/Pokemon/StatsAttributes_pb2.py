...
StatsAttributes = _reflection.GeneratedProtocolMessageType('StatsAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Pokemon.StatsAttributes_pb2'
