...
CameraAttributes = _reflection.GeneratedProtocolMessageType('CameraAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Pokemon.CameraAttributes_pb2'
