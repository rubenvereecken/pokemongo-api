...
# source: Settings/Master/Pokemon/EncounterAttributes.proto
...
_ENCOUNTERATTRIBUTES.fields_by_name['movement_type'].enum_type = Enums_dot_PokemonMovementType__pb2._POKEMONMOVEMENTTYPE
...
EncounterAttributes = _reflection.GeneratedProtocolMessageType('EncounterAttributes', (_message.Message,), dict(
  ...
  __module__ = 'Settings.Master.Pokemon.EncounterAttributes_pb2'
