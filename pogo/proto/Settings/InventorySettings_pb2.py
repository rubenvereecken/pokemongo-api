...
# source: Settings/InventorySettings.proto
...
InventorySettings = _reflection.GeneratedProtocolMessageType('InventorySettings', (_message.Message,), dict(
  ...
  __module__ = 'Settings.InventorySettings_pb2'
