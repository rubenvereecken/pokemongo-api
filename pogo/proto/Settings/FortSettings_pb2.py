...
# source: Settings/FortSettings.proto
...
FortSettings = _reflection.GeneratedProtocolMessageType('FortSettings', (_message.Message,), dict(
  ...
  __module__ = 'Settings.FortSettings_pb2'
