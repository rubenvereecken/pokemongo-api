...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/PlayerUpdateMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n6Networking/Requests/Messages/PlayerUpdateMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\":\n\x13PlayerUpdateMessage\x12\x10\n\x08latitude\x18\x01 \x01(\x01\x12\x11\n\tlongitude\x18\x02 \x01(\x01\x62\x06proto3')
)
...
PlayerUpdateMessage = _reflection.GeneratedProtocolMessageType('PlayerUpdateMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.PlayerUpdateMessage_pb2'
