...
_GETASSETDIGESTMESSAGE.fields_by_name['platform'].enum_type = Enums_dot_Platform__pb2._PLATFORM
...
GetAssetDigestMessage = _reflection.GeneratedProtocolMessageType('GetAssetDigestMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.GetAssetDigestMessage_pb2'
