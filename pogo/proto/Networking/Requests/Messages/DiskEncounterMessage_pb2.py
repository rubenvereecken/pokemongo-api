...
DiskEncounterMessage = _reflection.GeneratedProtocolMessageType('DiskEncounterMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.DiskEncounterMessage_pb2'
