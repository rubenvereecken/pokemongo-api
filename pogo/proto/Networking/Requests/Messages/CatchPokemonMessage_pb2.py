...
CatchPokemonMessage = _reflection.GeneratedProtocolMessageType('CatchPokemonMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.CatchPokemonMessage_pb2'
