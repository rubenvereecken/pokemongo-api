...
_USEITEMGYMMESSAGE.fields_by_name['item_id'].enum_type = Inventory_dot_ItemId__pb2._ITEMID
...
UseItemGymMessage = _reflection.GeneratedProtocolMessageType('UseItemGymMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.UseItemGymMessage_pb2'
