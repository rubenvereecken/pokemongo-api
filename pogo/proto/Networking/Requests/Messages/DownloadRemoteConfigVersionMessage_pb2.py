...
_DOWNLOADREMOTECONFIGVERSIONMESSAGE.fields_by_name['platform'].enum_type = Enums_dot_Platform__pb2._PLATFORM
...
DownloadRemoteConfigVersionMessage = _reflection.GeneratedProtocolMessageType('DownloadRemoteConfigVersionMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.DownloadRemoteConfigVersionMessage_pb2'
