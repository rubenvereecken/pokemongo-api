...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/LevelUpRewardsMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n8Networking/Requests/Messages/LevelUpRewardsMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"&\n\x15LevelUpRewardsMessage\x12\r\n\x05level\x18\x01 \x01(\x05\x62\x06proto3')
)
...
LevelUpRewardsMessage = _reflection.GeneratedProtocolMessageType('LevelUpRewardsMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.LevelUpRewardsMessage_pb2'
