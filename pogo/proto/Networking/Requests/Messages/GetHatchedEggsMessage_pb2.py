...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/GetHatchedEggsMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n8Networking/Requests/Messages/GetHatchedEggsMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\x17\n\x15GetHatchedEggsMessageb\x06proto3')
)
...
GetHatchedEggsMessage = _reflection.GeneratedProtocolMessageType('GetHatchedEggsMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.GetHatchedEggsMessage_pb2'
