...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/CheckAwardedBadgesMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n<Networking/Requests/Messages/CheckAwardedBadgesMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\x1b\n\x19\x43heckAwardedBadgesMessageb\x06proto3')
)
...
CheckAwardedBadgesMessage = _reflection.GeneratedProtocolMessageType('CheckAwardedBadgesMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.CheckAwardedBadgesMessage_pb2'
