...
# source: Networking/Requests/Messages/GetPlayerMessage.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/GetPlayerMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n3Networking/Requests/Messages/GetPlayerMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\x12\n\x10GetPlayerMessageb\x06proto3')
)
...
GetPlayerMessage = _reflection.GeneratedProtocolMessageType('GetPlayerMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.GetPlayerMessage_pb2'
