...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/IncenseEncounterMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n:Networking/Requests/Messages/IncenseEncounterMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"K\n\x17IncenseEncounterMessage\x12\x14\n\x0c\x65ncounter_id\x18\x01 \x01(\x03\x12\x1a\n\x12\x65ncounter_location\x18\x02 \x01(\tb\x06proto3')
)
...
IncenseEncounterMessage = _reflection.GeneratedProtocolMessageType('IncenseEncounterMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.IncenseEncounterMessage_pb2'
