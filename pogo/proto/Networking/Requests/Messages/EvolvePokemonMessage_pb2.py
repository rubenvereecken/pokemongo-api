...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/EvolvePokemonMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n7Networking/Requests/Messages/EvolvePokemonMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"*\n\x14\x45volvePokemonMessage\x12\x12\n\npokemon_id\x18\x01 \x01(\x06\x62\x06proto3')
)
...
EvolvePokemonMessage = _reflection.GeneratedProtocolMessageType('EvolvePokemonMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.EvolvePokemonMessage_pb2'
