...
_ATTACKGYMMESSAGE.fields_by_name['attack_actions'].message_type = Data_dot_Battle_dot_BattleAction__pb2._BATTLEACTION
_ATTACKGYMMESSAGE.fields_by_name['last_retrieved_actions'].message_type = Data_dot_Battle_dot_BattleAction__pb2._BATTLEACTION
...
AttackGymMessage = _reflection.GeneratedProtocolMessageType('AttackGymMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.AttackGymMessage_pb2'
