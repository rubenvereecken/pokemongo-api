...
EncounterMessage = _reflection.GeneratedProtocolMessageType('EncounterMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.EncounterMessage_pb2'
