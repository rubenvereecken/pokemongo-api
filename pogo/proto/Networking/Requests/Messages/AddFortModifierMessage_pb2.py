...
_ADDFORTMODIFIERMESSAGE.fields_by_name['modifier_type'].enum_type = Inventory_dot_ItemId__pb2._ITEMID
...
AddFortModifierMessage = _reflection.GeneratedProtocolMessageType('AddFortModifierMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.AddFortModifierMessage_pb2'
