...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/CollectDailyDefenderBonusMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\nCNetworking/Requests/Messages/CollectDailyDefenderBonusMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\"\n CollectDailyDefenderBonusMessageb\x06proto3')
)
...
CollectDailyDefenderBonusMessage = _reflection.GeneratedProtocolMessageType('CollectDailyDefenderBonusMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.CollectDailyDefenderBonusMessage_pb2'
