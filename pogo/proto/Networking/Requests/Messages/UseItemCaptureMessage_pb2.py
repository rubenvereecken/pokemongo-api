...
_USEITEMCAPTUREMESSAGE.fields_by_name['item_id'].enum_type = Inventory_dot_ItemId__pb2._ITEMID
...
UseItemCaptureMessage = _reflection.GeneratedProtocolMessageType('UseItemCaptureMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.UseItemCaptureMessage_pb2'
