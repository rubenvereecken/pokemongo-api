...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/DownloadItemTemplatesMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n?Networking/Requests/Messages/DownloadItemTemplatesMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\x1e\n\x1c\x44ownloadItemTemplatesMessageb\x06proto3')
)
...
DownloadItemTemplatesMessage = _reflection.GeneratedProtocolMessageType('DownloadItemTemplatesMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.DownloadItemTemplatesMessage_pb2'
