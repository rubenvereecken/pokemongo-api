...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/SetFavoritePokemonMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n<Networking/Requests/Messages/SetFavoritePokemonMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"D\n\x19SetFavoritePokemonMessage\x12\x12\n\npokemon_id\x18\x01 \x01(\x04\x12\x13\n\x0bis_favorite\x18\x02 \x01(\x08\x62\x06proto3')
)
...
SetFavoritePokemonMessage = _reflection.GeneratedProtocolMessageType('SetFavoritePokemonMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.SetFavoritePokemonMessage_pb2'
