...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/UseItemEggIncubatorMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n=Networking/Requests/Messages/UseItemEggIncubatorMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"A\n\x1aUseItemEggIncubatorMessage\x12\x0f\n\x07item_id\x18\x01 \x01(\t\x12\x12\n\npokemon_id\x18\x02 \x01(\x04\x62\x06proto3')
)
...
UseItemEggIncubatorMessage = _reflection.GeneratedProtocolMessageType('UseItemEggIncubatorMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.UseItemEggIncubatorMessage_pb2'
