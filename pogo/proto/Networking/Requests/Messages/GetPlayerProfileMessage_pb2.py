...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/GetPlayerProfileMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n:Networking/Requests/Messages/GetPlayerProfileMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\".\n\x17GetPlayerProfileMessage\x12\x13\n\x0bplayer_name\x18\x01 \x01(\tb\x06proto3')
)
...
GetPlayerProfileMessage = _reflection.GeneratedProtocolMessageType('GetPlayerProfileMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.GetPlayerProfileMessage_pb2'
