...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Requests/Messages/UpgradePokemonMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\n8Networking/Requests/Messages/UpgradePokemonMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"+\n\x15UpgradePokemonMessage\x12\x12\n\npokemon_id\x18\x01 \x01(\x04\x62\x06proto3')
)
...
UpgradePokemonMessage = _reflection.GeneratedProtocolMessageType('UpgradePokemonMessage', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Requests.Messages.UpgradePokemonMessage_pb2'
