...
_RESPONSEENVELOPE.fields_by_name['unknown6'].message_type = Networking_dot_Envelopes_dot_Unknown6__pb2._UNKNOWN6
_RESPONSEENVELOPE.fields_by_name['auth_ticket'].message_type = Networking_dot_Envelopes_dot_AuthTicket__pb2._AUTHTICKET
...
ResponseEnvelope = _reflection.GeneratedProtocolMessageType('ResponseEnvelope', (_message.Message,), dict(
  ...
  Unknown7 = _reflection.GeneratedProtocolMessageType('Unknown7', (_message.Message,), dict(
    ...
    __module__ = 'Networking.Envelopes.ResponseEnvelope_pb2'
