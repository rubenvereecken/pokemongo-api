...
_REQUESTENVELOPE.fields_by_name['requests'].message_type = Networking_dot_Requests_dot_Request__pb2._REQUEST
_REQUESTENVELOPE.fields_by_name['unknown6'].message_type = Networking_dot_Envelopes_dot_Unknown6__pb2._UNKNOWN6
_REQUESTENVELOPE.fields_by_name['auth_info'].message_type = _REQUESTENVELOPE_AUTHINFO
_REQUESTENVELOPE.fields_by_name['auth_ticket'].message_type = Networking_dot_Envelopes_dot_AuthTicket__pb2._AUTHTICKET
...
RequestEnvelope = _reflection.GeneratedProtocolMessageType('RequestEnvelope', (_message.Message,), dict(
  ...
  AuthInfo = _reflection.GeneratedProtocolMessageType('AuthInfo', (_message.Message,), dict(
    ...
    JWT = _reflection.GeneratedProtocolMessageType('JWT', (_message.Message,), dict(
      ...
      __module__ = 'Networking.Envelopes.RequestEnvelope_pb2'
