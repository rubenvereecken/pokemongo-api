...
_FORTRECALLPOKEMONRESPONSE.fields_by_name['fort_details'].message_type = Networking_dot_Responses_dot_FortDetailsResponse__pb2._FORTDETAILSRESPONSE
...
FortRecallPokemonResponse = _reflection.GeneratedProtocolMessageType('FortRecallPokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.FortRecallPokemonResponse_pb2'
