...
CheckCodenameAvailableResponse = _reflection.GeneratedProtocolMessageType('CheckCodenameAvailableResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.CheckCodenameAvailableResponse_pb2'
