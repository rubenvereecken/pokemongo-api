...
SetFavoritePokemonResponse = _reflection.GeneratedProtocolMessageType('SetFavoritePokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.SetFavoritePokemonResponse_pb2'
