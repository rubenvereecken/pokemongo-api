...
_SETCONTACTSETTINGSRESPONSE.fields_by_name['player_data'].message_type = Data_dot_PlayerData__pb2._PLAYERDATA
...
SetContactSettingsResponse = _reflection.GeneratedProtocolMessageType('SetContactSettingsResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.SetContactSettingsResponse_pb2'
