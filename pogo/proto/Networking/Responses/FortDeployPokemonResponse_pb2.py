...
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name['fort_details'].message_type = Networking_dot_Responses_dot_FortDetailsResponse__pb2._FORTDETAILSRESPONSE
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name['pokemon_data'].message_type = Data_dot_PokemonData__pb2._POKEMONDATA
_FORTDEPLOYPOKEMONRESPONSE.fields_by_name['gym_state'].message_type = Data_dot_Gym_dot_GymState__pb2._GYMSTATE
...
FortDeployPokemonResponse = _reflection.GeneratedProtocolMessageType('FortDeployPokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.FortDeployPokemonResponse_pb2'
