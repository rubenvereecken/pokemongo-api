...
GetIncensePokemonResponse = _reflection.GeneratedProtocolMessageType('GetIncensePokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.GetIncensePokemonResponse_pb2'
