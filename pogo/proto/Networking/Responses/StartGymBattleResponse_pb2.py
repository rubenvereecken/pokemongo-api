...
# source: Networking/Responses/StartGymBattleResponse.proto
...
_STARTGYMBATTLERESPONSE.fields_by_name['defender'].message_type = Data_dot_Battle_dot_BattleParticipant__pb2._BATTLEPARTICIPANT
_STARTGYMBATTLERESPONSE.fields_by_name['battle_log'].message_type = Data_dot_Battle_dot_BattleLog__pb2._BATTLELOG
...
StartGymBattleResponse = _reflection.GeneratedProtocolMessageType('StartGymBattleResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.StartGymBattleResponse_pb2'
