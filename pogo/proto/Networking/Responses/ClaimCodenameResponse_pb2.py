...
ClaimCodenameResponse = _reflection.GeneratedProtocolMessageType('ClaimCodenameResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.ClaimCodenameResponse_pb2'
