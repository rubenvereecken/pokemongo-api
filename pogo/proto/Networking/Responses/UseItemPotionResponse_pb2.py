...
UseItemPotionResponse = _reflection.GeneratedProtocolMessageType('UseItemPotionResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.UseItemPotionResponse_pb2'
