...
_UPGRADEPOKEMONRESPONSE.fields_by_name['upgraded_pokemon'].message_type = Data_dot_PokemonData__pb2._POKEMONDATA
...
UpgradePokemonResponse = _reflection.GeneratedProtocolMessageType('UpgradePokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.UpgradePokemonResponse_pb2'
