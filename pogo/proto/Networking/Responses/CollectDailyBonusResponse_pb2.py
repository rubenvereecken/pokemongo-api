...
CollectDailyBonusResponse = _reflection.GeneratedProtocolMessageType('CollectDailyBonusResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.CollectDailyBonusResponse_pb2'
