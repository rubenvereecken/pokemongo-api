...
_SETAVATARRESPONSE.fields_by_name['player_data'].message_type = Data_dot_PlayerData__pb2._PLAYERDATA
...
SetAvatarResponse = _reflection.GeneratedProtocolMessageType('SetAvatarResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.SetAvatarResponse_pb2'
