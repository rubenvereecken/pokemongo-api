...
_INCENSEENCOUNTERRESPONSE.fields_by_name['pokemon_data'].message_type = Data_dot_PokemonData__pb2._POKEMONDATA
_INCENSEENCOUNTERRESPONSE.fields_by_name['capture_probability'].message_type = Data_dot_Capture_dot_CaptureProbability__pb2._CAPTUREPROBABILITY
...
IncenseEncounterResponse = _reflection.GeneratedProtocolMessageType('IncenseEncounterResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.IncenseEncounterResponse_pb2'
