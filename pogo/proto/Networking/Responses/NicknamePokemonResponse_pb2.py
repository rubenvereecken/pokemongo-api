...
NicknamePokemonResponse = _reflection.GeneratedProtocolMessageType('NicknamePokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.NicknamePokemonResponse_pb2'
