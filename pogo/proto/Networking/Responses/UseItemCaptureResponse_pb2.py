...
UseItemCaptureResponse = _reflection.GeneratedProtocolMessageType('UseItemCaptureResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.UseItemCaptureResponse_pb2'
