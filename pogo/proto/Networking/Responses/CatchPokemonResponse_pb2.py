...
_CATCHPOKEMONRESPONSE.fields_by_name['capture_award'].message_type = Data_dot_Capture_dot_CaptureAward__pb2._CAPTUREAWARD
...
CatchPokemonResponse = _reflection.GeneratedProtocolMessageType('CatchPokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.CatchPokemonResponse_pb2'
