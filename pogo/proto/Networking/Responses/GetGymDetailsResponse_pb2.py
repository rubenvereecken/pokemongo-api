...
_GETGYMDETAILSRESPONSE.fields_by_name['gym_state'].message_type = Data_dot_Gym_dot_GymState__pb2._GYMSTATE
...
GetGymDetailsResponse = _reflection.GeneratedProtocolMessageType('GetGymDetailsResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.GetGymDetailsResponse_pb2'
