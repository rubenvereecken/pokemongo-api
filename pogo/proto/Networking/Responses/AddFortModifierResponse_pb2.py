...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Networking/Responses/AddFortModifierResponse.proto',
  package='POGOProtos.Networking.Responses',
  syntax='proto3',
  serialized_pb=_b('\n2Networking/Responses/AddFortModifierResponse.proto\x12\x1fPOGOProtos.Networking.Responses\"\x19\n\x17\x41\x64\x64\x46ortModifierResponseb\x06proto3')
)
...
AddFortModifierResponse = _reflection.GeneratedProtocolMessageType('AddFortModifierResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.AddFortModifierResponse_pb2'
