...
RecycleInventoryItemResponse = _reflection.GeneratedProtocolMessageType('RecycleInventoryItemResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.RecycleInventoryItemResponse_pb2'
