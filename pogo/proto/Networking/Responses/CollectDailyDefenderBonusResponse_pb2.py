...
CollectDailyDefenderBonusResponse = _reflection.GeneratedProtocolMessageType('CollectDailyDefenderBonusResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.CollectDailyDefenderBonusResponse_pb2'
