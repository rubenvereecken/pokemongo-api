...
UseItemGymResponse = _reflection.GeneratedProtocolMessageType('UseItemGymResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.UseItemGymResponse_pb2'
