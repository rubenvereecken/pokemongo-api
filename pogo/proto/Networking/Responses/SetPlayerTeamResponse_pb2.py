...
_SETPLAYERTEAMRESPONSE.fields_by_name['player_data'].message_type = Data_dot_PlayerData__pb2._PLAYERDATA
...
SetPlayerTeamResponse = _reflection.GeneratedProtocolMessageType('SetPlayerTeamResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.SetPlayerTeamResponse_pb2'
