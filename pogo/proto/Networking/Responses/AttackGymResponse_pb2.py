...
_ATTACKGYMRESPONSE.fields_by_name['battle_log'].message_type = Data_dot_Battle_dot_BattleLog__pb2._BATTLELOG
_ATTACKGYMRESPONSE.fields_by_name['active_defender'].message_type = Data_dot_Battle_dot_BattlePokemonInfo__pb2._BATTLEPOKEMONINFO
_ATTACKGYMRESPONSE.fields_by_name['active_attacker'].message_type = Data_dot_Battle_dot_BattlePokemonInfo__pb2._BATTLEPOKEMONINFO
...
AttackGymResponse = _reflection.GeneratedProtocolMessageType('AttackGymResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.AttackGymResponse_pb2'
