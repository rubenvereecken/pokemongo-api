...
_USEITEMEGGINCUBATORRESPONSE.fields_by_name['egg_incubator'].message_type = Inventory_dot_EggIncubator__pb2._EGGINCUBATOR
...
UseItemEggIncubatorResponse = _reflection.GeneratedProtocolMessageType('UseItemEggIncubatorResponse', (_message.Message,), dict(
  ...
  __module__ = 'Networking.Responses.UseItemEggIncubatorResponse_pb2'
