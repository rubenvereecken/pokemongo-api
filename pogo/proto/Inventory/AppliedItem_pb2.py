...
_APPLIEDITEM.fields_by_name['item_id'].enum_type = Inventory_dot_ItemId__pb2._ITEMID
_APPLIEDITEM.fields_by_name['item_type'].enum_type = Inventory_dot_ItemType__pb2._ITEMTYPE
...
AppliedItem = _reflection.GeneratedProtocolMessageType('AppliedItem', (_message.Message,), dict(
  ...
  __module__ = 'Inventory.AppliedItem_pb2'
