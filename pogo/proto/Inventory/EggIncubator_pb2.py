...
_EGGINCUBATOR.fields_by_name['item_id'].enum_type = Inventory_dot_ItemId__pb2._ITEMID
_EGGINCUBATOR.fields_by_name['incubator_type'].enum_type = Inventory_dot_EggIncubatorType__pb2._EGGINCUBATORTYPE
...
EggIncubator = _reflection.GeneratedProtocolMessageType('EggIncubator', (_message.Message,), dict(
  ...
  __module__ = 'Inventory.EggIncubator_pb2'
