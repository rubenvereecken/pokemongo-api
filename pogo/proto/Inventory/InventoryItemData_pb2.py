...
_INVENTORYITEMDATA.fields_by_name['pokemon_family'].message_type = Inventory_dot_PokemonFamily__pb2._POKEMONFAMILY
...
InventoryItemData = _reflection.GeneratedProtocolMessageType('InventoryItemData', (_message.Message,), dict(
  ...
  __module__ = 'Inventory.InventoryItemData_pb2'
