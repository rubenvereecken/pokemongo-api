...
from POGOProtos.Enums import PokemonClass_pb2 as POGOProtos_dot_Enums_dot_PokemonClass__pb2
...
_POKEMONSETTINGS.fields_by_name['class'].enum_type = POGOProtos_dot_Enums_dot_PokemonClass__pb2._POKEMONCLASS
