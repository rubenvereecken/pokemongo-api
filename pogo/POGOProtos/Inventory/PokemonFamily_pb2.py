...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='POGOProtos/Inventory/PokemonFamily.proto',
...
_POKEMONFAMILY.fields_by_name['family_id'].enum_type = POGOProtos_dot_Enums_dot_PokemonFamilyId__pb2._POKEMONFAMILYID
...
PokemonFamily = _reflection.GeneratedProtocolMessageType('PokemonFamily', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Inventory.PokemonFamily_pb2'
